...
//  Calculator 3
//
//  Created by Тимур Гарипов on 30.07.22.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func equalsTap(_ sender: Any) {
        ...
        if(validInput()){
            let chekedWorkingsForPercent = workings.replacingOccurrences(of: "%", with: "*0.01")
            let expression = NSExpression(format: chekedWorkingsForPercent)
